/// \file
/// \brief generic target-agnostic assembly parser
///
/// “but... isn't that impossible...?”
///
/// Well strictly yes, in the sense that different platforms do not have a
/// common assembly format. Even different assemblers do not have a common
/// format. Instead of trying to cope directly with this variation, this parser
/// works on the fuzzy notion that each line of an assembly file consists of one
...
///
/// (1) and (2) give us enough pre-processor functionality for Clink’s needs.
/// For (3), the rules for what can be a function name are essentially
