...
static int next(clink_iter_t *it, const clink_symbol_t **yielded) {
  ...
  s->last.parent = (char *)sqlite3_column_text(s->stmt, 9);
  s->last.context = (char *)sqlite3_column_text(s->stmt, 10);
...
int clink_db_find_symbol(clink_db_t *db, const char *regex, clink_iter_t **it) {
  ...
  static const char QUERY[] =
      ...
      "symbols.col, symbols.start_line, symbols.start_col, symbols.end_line, "
      "symbols.end_col, symbols.parent, content.body from symbols "
